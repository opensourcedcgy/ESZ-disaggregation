...
class WashingMachineClassifier(Classifier):

    def __init__(self, name='WASHING_MACHINE', model_name=None, **kws):
        self.name = name
        self.model_name = model_name
        self.model_path = '/models/{}/{}/1/'.format(self.name.lower(), model_name)
        self.prob = 0.5
        self.post_processing_steps = ['post_process_washing_machine']
        self.sample_period_seconds = 6
        self.seq_len = 1024

        self.net_dict = {}
        self.target_scale = 3999
